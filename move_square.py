...
class Square():
    ...
    def main_loop(self):
        while not self.ctrl_c:
            print(f"Front: {self.forward_reading}     ForwardLeft: {self.forwardleft_reading}        ForwardRight: {self.forwardright_reading}      BackLeft: {self.backleft_reading}       Backright: {self.backright_reading}")
